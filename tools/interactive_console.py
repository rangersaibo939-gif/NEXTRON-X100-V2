...
def make_interactive(project_root: str) -> Path:
    ...
    replacements = {
        ...
        'Button(onClick = { lastAction = "Build APK"; actionCount++ }) { Text("Build APK") }': 'Button(onClick = { lastAction = "APK build requested — latest Builder pipeline will produce the APK"; actionCount++ }) { Text("Build APK") }',
